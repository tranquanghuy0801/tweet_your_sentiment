...
// const doesDocumentExist = function(collectionId, documentid){;
// 	let collectionUrl = uriFactory.createDocumentUri(databaseId, collectionId);
...
//  */
// function queryCollection(subreddit,collectionId) {
// 	console.log(`Querying collection through index:\n${collectionId}`);
// 	let collectionUrl = uriFactory.createDocumentCollectionUri(databaseId, collectionId);
// 	const query = 'SELECT VALUE r.score FROM root r WHERE r.subreddit.display_name = "' + subreddit + '"';
// 	console.log(query);
// 	return new Promise((resolve, reject) => {
